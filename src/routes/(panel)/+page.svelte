        ...
        <div class="flex flex-col gap-4">
            {#each panels as panel}
                <div class="flex gap-4 items-center">
                    ...
                    <div class="flex-none">
                        <a href="/panel/{panel.id}">select</a>
                    </div>
                </div>
            {/each}
        </div>
...
{:else}
    <Container>
        <div class="w-full flex items-center flex-wrap justify-center gap-10 min-h-[600px]">
            <div class="grid gap-4 w-60">
                ...
                <div>
                    <h2 class="text-center text-black text-base font-semibold leading-relaxed pb-1">You have no access</h2>
                    <p class="text-center text-black text-sm font-normal leading-snug pb-4">Chat with owner to get access </p> 
                </div>
            </div>
        </div>
    </Container>
