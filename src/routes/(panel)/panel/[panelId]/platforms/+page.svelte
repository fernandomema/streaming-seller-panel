<script lang="ts">
    ...
    const platforms: Prisma.PanelProviderSelect[] = $page.data.platforms; 
    ...
    const newPlatform: any = {
        ...
        icon: {
            value: "i-tabler-device-unknown-filled",
            error: false,
        },
    };
    ...
    const submitNewPlatform = async (e) => {
        ...
        Object.keys(newPlatform).forEach(key => newPlatform[key].error = false);

        let response = await fetch(`/panel/${$page.data.panelId}/platforms/create/submit`, {
            method: "POST",
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="#" class="btn btn-primary hidden sm:flex" data-bs-toggle="modal" data-bs-target="#modal-platform">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 5l0 14"></path><path d="M5 12l14 0"></path></svg>
                            Add new platform
                        </a>
                        <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#modal-platform" aria-label="Create new Platform">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 5l0 14"></path><path d="M5 12l14 0"></path></svg>
                        </a>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            <div class="col-auto bg-slate-200 rounded-md flex items-center w-[40px] h-[40px] p-1">
                                <i class="{platform.icon} text-[50px]"></i>
                            </div>
                            <div class="col text-truncate">
                                <a href="/panel/{$page.data.panelId}/platforms/{platform.id}/edit" class="text-body d-block">{platform.name}</a>
      ...
      <div class="page-body">
        <div class="container-xl my-auto">
          <div class="empty">
            ...
            <p class="empty-title">No platforms found</p>
            <p class="empty-subtitle text-secondary">
              You don't added any platform yet
            </p>
            <div class="empty-action">
              <a href="./." class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-platform">
                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 5l0 14"></path><path d="M5 12l14 0"></path></svg>
...
{/if}
  ...
  <div class="modal modal-blur fade" id="modal-platform" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="example-text-input" placeholder="Your provider name" bind:value={newPlatform.name.value} class:is-invalid={newPlatform.name.error}>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-2">
                <span class="input-group-text">
                    <i class="text-[24px] {newPlatform.icon.value}"></i>
                </span>
                <input type="text" class="form-control" placeholder="icon name" bind:value={newPlatform.icon.value} class:is-invalid={newPlatform.icon.error}>
            </div>
        </div>
        ...
        <div class="modal-footer">
          ...
          <a href="#" class="btn btn-primary ms-auto" on:click={submitNewPlatform}>
            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 5l0 14"></path><path d="M5 12l14 0"></path></svg>
            Create new platform
          </a>
